#!/usr/bin/env python3
"""
Script para desplegar el repositorio ECR
Uso: python scripts/deploy-ecr.py
"""
...
TEMPLATE_FILE = "cloudformation/02-ecr.yml"
REGION = "us-east-1"

def main():
    print("Desplegando repositorio ECR...")
    ...
    try:
        ...
        print("\nPróximo paso:")
        print("  1. Construir imagen Docker: cd app-ecs && docker build -t notes-app .")
        print("  2. Subir imagen: python scripts/push-image.py")
